...
{
    /// <inheritdoc />
    public partial class AddDbTablesAndSeeders : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListPrice = table.Column<decimal>(type: "decimal(38,2)", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(38,2)", nullable: false),
                    Price50 = table.Column<decimal>(type: "decimal(38,2)", nullable: false),
                    Price100 = table.Column<decimal>(type: "decimal(38,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderTotal = table.Column<decimal>(type: "decimal(38,2)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "City", "CompanyId", "ConcurrencyStamp", "Discriminator", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "Name", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "PostalCode", "SecurityStamp", "State", "StreetAddress", "TwoFactorEnabled", "UserName" },
                values: new object[] { "0ed56266-b859-474f-95dc-a60e217f7554", 0, "Chicago", 2, "06d6e51c-e48f-4f5e-8ce9-26965690f79e", "ApplicationUser", "testcompany@gmail.com", false, false, null, "Ben Peter (Company)", null, null, null, "7735457827", false, "60634", "ce8c5864-02ea-4a07-b3f6-4bbe530cbbae", "IL", "3435 N Central Ave", false, "testcompany@gmail.com" });
